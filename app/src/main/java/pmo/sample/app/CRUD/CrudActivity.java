...
public class CrudActivity extends Activity {
    ...
    private void checkUser() {
        ...
        if(isEmpty(getNIM)|| isEmpty(getNama)|| isEmpty(getProdi)|| isEmpty(getFakultas)|| TextUtils.isEmpty(getAlamat) ||TextUtils.isEmpty(getHasilgol)||outputgolongan.equals("")||outputgolongan==null||TextUtils.isEmpty(getIpk)||TextUtils.isEmpty(getRjeniskelamin)||TextUtils.isEmpty(getCrudemail)||TextUtils.isEmpty(getTgllahir)||TextUtils.isEmpty(getNohp)||uri == null){
